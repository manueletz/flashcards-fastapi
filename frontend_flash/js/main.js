...
// --- Init desactivado (antes cargaba desde LocalStorage) ---
...
window.addEventListener("load", async () => {
  await initApp(); // carga desde FastAPI + Oracle

  // Después de cargar las cards desde el backend, inicializamos la UI
  clampCurrentIndexToFilter();
  renderAll();
